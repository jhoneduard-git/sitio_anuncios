...
urlpatterns = [
    ...
    path('mis-anuncios/editar/<int:id>/', views.editar_anuncio, name='editar_anuncio'),
    path('mis-anuncios/eliminar-foto/<int:foto_id>/', views.eliminar_foto, name='eliminar_foto'),
